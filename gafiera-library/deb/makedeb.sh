...
################################################################################
mkdir -p $INSTALLPATH/usr/share/dia/shapes/gafieira-notation/
mkdir -p $INSTALLPATH/usr/share/dia/sheets/
cp -v -f $SRCPATH/dia-shapes/shapes/gafieira-notation/*.png   $INSTALLPATH/usr/share/dia/shapes/gafieira-notation/
cp -v -f $SRCPATH/dia-shapes/shapes/gafieira-notation/*.shape $INSTALLPATH/usr/share/dia/shapes/gafieira-notation/
