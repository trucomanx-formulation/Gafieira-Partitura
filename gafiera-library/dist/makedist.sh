...
################################################################################
mkdir -p $INSTALLPATH/shapes/gafieira-notation/
mkdir -p $INSTALLPATH/sheets/
cp -f $SRCPATH/dia-shapes/shapes/gafieira-notation/*.png   $INSTALLPATH/shapes/gafieira-notation/
cp -f $SRCPATH/dia-shapes/shapes/gafieira-notation/*.shape $INSTALLPATH/shapes/gafieira-notation/
